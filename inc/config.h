...
#define COMM_DEACV_HI          80   // [rpm] Commutation method deactivation speed high (above this value the control switches from Commutation method to Selected method above)
#define COMM_ACV_LO            70   // [rpm] Commutation method activation speed low
